...
<head>
<meta charset="UTF-8">
<title>Aggiorna Metodi di Pagamento</title>
	<link rel="stylesheet"
...
<body class="bodyCard">
	...
	<form action="aggiornaCarta" method="post">
			...
			<div class="creditcard">
					...
					<svg version="1.1" id="cardfront"
                        ...
                        <g id="Front">
							...
							class="st2 st5 st6">JOHN
                                DOE</text>
                            <text
							transform="matrix(1 0 0 1 54.1074 389.8793)" class="st7 st5 st8">cardholder
                                name</text>
                            <text
				...
				<div class="back">
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                            ...
                            <g class="st8">
                                <text
							transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">security
                                    code</text>
                            </g>
		...
		<div class="form-container">
			...
			<div class="field-container">
				<label for="cardnumber">Card Number</label><span id="generatecard">generate
					random</span> <input id="cardnumber" type="text" name="numCarta">
			...
			<div class="field-container">
				<label for="expirationdate">Expiration (mm/yy)</label> <input
					id="expirationdate" type="text" name="scadenza">
			</div>
			<div class="field-container">
